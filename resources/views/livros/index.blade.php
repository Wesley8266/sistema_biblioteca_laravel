...
<body class="bg-[#1c1716]">
    ...
    <main class="ml-64 p-8">
        ...
        <p class="text-[#95887a] mb-4">Gerencie as Livros da biblioteca</p>
            ...
            <table class="w-full text-left bg-[#181514]">
                ...
                <thead>
                    <tr class="bg-[#1b1816] text-[#E28300] ">
                        ...
                        <th class="font-bold py-4">Titulo</th>
                        <th class="font-bold py-4 px-4">Autor</th>
                        <th class="font-bold py-4">Categoria</th>
